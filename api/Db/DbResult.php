...
class DbResult{
	...
	public function setNumRows( int $value ){ $this->num_rows = $value; }
	public function setData( array $value ){ $this->data = $value; }
	
	public function getNumRows(){ return $this->num_rows; }
	public function getData(){ return $this->data; }
	public function getSingleData(){ return ($this->getNumRows() > 0)?$this->data[0]:null; }
